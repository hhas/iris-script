...
func stdlib_loadOperators(into registry: OperatorRegistry) {
    ...
    registry.add([.keyword(["+", "positive", "＋"]), .expression], 1298, .left, reductionForPositiveOperator)
    registry.add([.keyword(["-", "negative", "－", "−", "﹣"]), .expression], 1298, .left, reductionForNegativeOperator)
    ...
    registry.add([.keyword("before"), .expression], 1106, .right, reductionForAtomOperator)
    registry.add([.keyword("after"), .expression], 1106, .right, reductionForAtomOperator)
