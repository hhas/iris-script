...
func stdlib_loadOperators(into registry: OperatorRegistry) {
    ...
    registry.add([.keyword("after"), .expressionLabeled("reference")], 1106, .left)
    registry.add([.expressionLabeled("element_type"), .keyword("after"), .expressionLabeled("reference")], 1106, .right)
    ...
    registry.add([.keyword("before"), .expressionLabeled("reference")], 1106, .left)
    registry.add([.expressionLabeled("element_type"), .keyword("before"), .expressionLabeled("reference")], 1106, .right)
