...
*/
    ...
    registry.add([.keyword("to"), .boundExpression("interface", "interface"), .keyword("perform"), .boundExpression("action", "action")], 80, .left)
    registry.add([.keyword("when"), .boundExpression("interface", "interface"), .keyword("perform"), .boundExpression("action", "action")], 80, .left)
