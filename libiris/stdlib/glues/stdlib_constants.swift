...
public func stdlib_loadConstants(into env: Environment) {
    ...
    env.define(coercion: AsSwiftPrecis(AsSwiftDefault(asValue, default: nullValue), "with_default")) // TO DO: AsDefault requires constraint args (coercion and defaultValue) to instantiate; native language will call() it to create new instances with appropriate constraints // TO DO: need to review SwiftCoercion usage within native environment // TO DO: should `with_default` be an optional clause to `optional…with_default…`?
