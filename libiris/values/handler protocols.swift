...
public extension Callable {
    ...
    var interface: HandlerType { return nullHandlerType } // unknown interface; used internally by DynamicallyBoundHandler &co; also returned by EditableValue.interface if contained value isn’t callable
