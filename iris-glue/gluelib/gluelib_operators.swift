...
func gluelib_loadOperators(into registry: OperatorRegistry) {
    ...
    registry.add(["swift_choice", .expression, "requires", .expression], 180)
    ...
    // TO DO: rename `expression`/`boundExpression` to `operand`/`[named|labeled]Operand`
