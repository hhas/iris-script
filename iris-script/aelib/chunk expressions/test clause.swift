...
struct TestClauseScope: Accessor {
    ...
    func get(_ name: Symbol) -> Value? {
        ...
        case "is":            return ComparisonSelector(appData: self.appData, form: .eq, isNumeric: false)
        case "≠":             return ComparisonSelector(appData: self.appData, form: .ne, isNumeric: true)
        case "is_not":        return ComparisonSelector(appData: self.appData, form: .ne, isNumeric: false)
