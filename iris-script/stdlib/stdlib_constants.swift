...
func stdlib_loadConstants(into env: Environment) {
 ...
 //   env.define("true", trueValue)
//    env.define("false", falseValue)
    ...
    env.define(coercion: AsDefault(asAnything, defaultValue: nullValue)) // note: AsDefault requires constraint args (coercion and defaultValue) to instantiate; native language will call() it to create new instances with appropriate constraints
