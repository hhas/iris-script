...
public struct PrimitiveHandler: Handler {
    ...
    public typealias Call = (_ command: Command, _ commandEnv: Scope, _ handler: Handler, _ handlerEnv: Scope, _ coercion: Coercion) throws -> Value // all generated `procedure_NAME_PARAMS` functions in _handlers.swift glue have this signature
    ...
    public func call(with command: Command, in commandEnv: Scope, as coercion: Coercion) throws -> Value {
